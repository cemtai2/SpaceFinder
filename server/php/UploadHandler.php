...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        //    'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/'.$_GET['priKey'].'/',
                'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/../../images/uploads/'.$_GET['priKey'].'/',
            //'upload_url' => $this->get_full_url().'/files/'.$_GET['priKey'].'/',
            'upload_url' => $this->get_full_url().'/../../images/uploads/'.$_GET['priKey'].'/',
