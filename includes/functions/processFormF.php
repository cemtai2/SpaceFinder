...
{
			$street = $_POST['street']; $city = $_POST['city'];  $sqftTotal = $_POST['sqftTotal']; $sqftFin = $_POST['sqftFin']; $sqftUnFin = $_POST['sqftUnFin']; $lot = $_POST['lot']; $levels = $_POST['levels']; $age = $_POST['age']; $price = $_POST['price']; $rooms = $_POST['rooms'];  $beds = $_POST['beds']; $baths = $_POST['baths']; $garageSize = $_POST['garageSize']; $basement = $_POST['basement']; $basementFloor = $_POST['basementFloor']; $typeKitchen = $_POST['typeKitchen']; $kitchenFloor = $_POST['kitchenFloor']; $kitchenCounter = $_POST['kitchenCounter']; $kitchenCabinets = $_POST['kitchenCabinets']; $bathFloorA = varSet('bathFloorA'); $bathCounterA = varSet('bathCounterA'); $showerStallA = varSet('showerStallA'); $bathStorageA = varSet('bathStorageA'); $bathFloorB = varSet('bathFloorB'); $bathCounterB = varSet('bathCounterB'); $showerStallB = varSet('showerStallB'); $bathStorageB = varSet('bathStorageB');	$bathFloorC = varSet('bathFloorC'); $bathCounterC = varSet('bathCounterC'); $showerStallC = varSet('showerStallC'); $bathStorageC = varSet('bathStorageC'); $bathFloorD = varSet('bathFloorD'); $bathCounterD = varSet('bathCounterD'); $showerStallD = varSet('showerStallD'); $bathStorageD = varSet('bathStorageD');	$bathFloorE = varSet('bathFloorE'); $bathCounterE = varSet('bathCounterE'); $showerStallE = varSet('showerStallE'); $bathStorageE = varSet('bathStorageE'); $mBedFloor = $_POST['mBedFloor']; $mBedCloset = $_POST['mBedCloset']; $bedFloor = $_POST['bedFloor']; $bedCloset = $_POST['bedCloset']; $mBathFloor = $_POST['mBathFloor']; $mBathLinen = $_POST['mBathLinen']; $hallOne = $_POST['hallOne']; $hallTwo = $_POST['hallTwo']; $hallThree = $_POST['hallThree']; $hallFour = $_POST['hallFour']; $fenceType = $_POST['fenceType']; $lRoom = $_POST['lRoom']; $lStorage = $_POST['lStorage']; $lLevel = $_POST['lLevel']; $cabSpace = $_POST['cabSpace']; $pantry = $_POST['pantry']; $den = $_POST['den']; $rec = $_POST['rec']; $sun = $_POST['sun']; $mud = $_POST['mud']; $office = $_POST['office']; $fireplace = $_POST['fireplace']; $fridge = $_POST['fridge']; $oven = $_POST['oven']; $oRange = $_POST['oRange']; $disposal = $_POST['disposal']; $dishwasher = $_POST['dishwasher']; $breakfastBar = $_POST['breakfastBar']; $microwave = $_POST['microwave']; $washer = $_POST['washer']; $dryer = $_POST['dryer']; $pool = $_POST['pool']; $hTub = $_POST['hTub']; $deck = $_POST['deck']; $ha = $_POST['ha'];  $gradeschool = $_POST['gradeschool']; $midschool = $_POST['midschool']; $highschool = $_POST['highschool']; $notes = $_POST['notes']; $distance = $_POST['distance']; $propTax = $_POST['propTax'];  $daysOnMarket = $_POST['daysOnMarket']; $heat = $_POST['heat']; 
...
//$rating = rating($valArray);
	...
	{
		case 'add':
		$sql="INSERT INTO space ( street, city, sqftTotal, sqftFin, sqftUnFin, lot, levels, age, price, rooms, beds, baths, garageSize, basement, basementFloor, typeKitchen, kitchenFloor, kitchenCounter, kitchenCabinets, bathFloorA, bathCounterA, showerStallA, bathStorageA, bathFloorB, bathCounterB, showerStallB, bathStorageB, bathFloorC, bathCounterC, showerStallC, bathStorageC, bathFloorD, bathCounterD, showerStallD, bathStorageD, bathFloorE, bathCounterE, showerStallE, bathStorageE, mBedCloset, bedFloor, bedCloset, mBathFloor, mBathLinen, hallOne, hallTwo, hallThree, hallFour, fenceType, lRoom, lStorage, lLevel, cabSpace, pantry, den, rec, sun, mud, office, fireplace, fridge, oven, oRange, disposal, dishwasher, breakfastBar, microwave, washer, dryer, pool, hTub, deck, ha, gradeschool, midschool, highschool, notes, distance, propTax, daysOnMarket, heat )
		VALUES
		(	'$street', '$city', '$sqftTotal', '$sqftFin', '$sqftUnFin', '$lot', '$levels', '$age', '$price', '$rooms', '$beds', '$baths', '$garageSize', '$basement', '$basementFloor', '$typeKitchen', '$kitchenFloor', '$kitchenCounter', '$kitchenCabinets', '$bathFloorA', '$bathCounterA', '$showerStallA', '$bathStorageA', '$bathFloorB', '$bathCounterB', '$showerStallB', '$bathStorageB', '$bathFloorC', '$bathCounterC', '$showerStallC', '$bathStorageC', '$bathFloorD', '$bathCounterD', '$showerStallD', '$bathStorageD', '$bathFloorE', '$bathCounterE', '$showerStallE', '$bathStorageE', '$mBedCloset', '$bedFloor', '$bedCloset', '$mBathFloor', '$mBathLinen', '$hallOne', '$hallTwo', '$hallThree', '$hallFour', '$fenceType', '$lRoom', '$lStorage', '$lLevel', '$cabSpace', '$pantry', '$den', '$rec', '$sun', '$mud', '$office', '$fireplace', '$fridge', '$oven', '$oRange', '$disposal', '$dishwasher', '$breakfastBar', '$microwave', '$washer', '$dryer', '$pool', '$hTub', '$deck', '$ha', '$gradeschool', '$midschool', '$highschool', '$notes', '$distance', '$propTax', '$daysOnMarket', '$heat')";
